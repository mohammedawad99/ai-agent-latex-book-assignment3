...
- [x] Stage 9.3 — full LaTeX chapter conversion (prose, tables, equations, listings, BiDi, citations from `content/book.md`; LaTeX sources content-complete). No compile attempted because TeX Live is not installed; **no PDF**. (Committed and pushed: `38f8c86`.) **Stage 9.4 (first compile) is next.**
...
- [ ] 9.4 — first compile; fix compile errors (build sequence above) (**next stage**; requires the manual TeX Live install first).
