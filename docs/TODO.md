...
- [x] Stage 9.1 — LaTeX skeleton + bibliography (`main.tex`, `preamble.tex`, `chapters/` stubs, `references.bib`, `latex_project/README.md`). No compile attempted because TeX Live is not installed; no figures/scripts; **no PDF**. (Committed and pushed: `af71265`.) **Stage 9.2 (figure/graph scripts) is next.**
...
- [ ] 9.2 — figure/graph generation scripts + generated images under `figures/` (**next stage**).
