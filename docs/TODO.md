...
- [~] Stage 9.3 — full LaTeX chapter conversion created and accepted for commit (prose, tables, equations, listings, BiDi, citations from `content/book.md`). No compile attempted because TeX Live is not installed; **no PDF**. (Commit hash recorded in the next docs update.)
